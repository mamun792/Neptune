...
<head>
    ...
    <body class="theme-bg">
        ...
        <h2> 
         <?php $id=$_GET['id']; 
         $select="SELECT * FROM `portflio` where id='$id' ";
                        ...
                        <div class="col-xl-9 col-lg-10">
                            <div class="single-blog-list">
                                <div class="blog-list-thumb mb-35">
                                    <img src="Views/backend/imges/portflio/<?=$read['photo'];?>" alt="img">
                                </div>
                                <div class="blog-list-content blog-details-content portfolio-details-content">
                                    <p><?=$read['p_descprition'];?></p>
                                    ...
                                    <ul>
                                        <li>
                                            <div class="post-avatar-img">
                                                <img src="assets/fontent/img/blog/post_avatar_img.png" alt="img">
                                            </div>
