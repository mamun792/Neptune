                            ...
                            <div class="col-md-6 m-auto">
                                <div class="widget-stats-large-info-container">
                                    <div class="card-header ">
                                        <h3 class="card-title fs-2 fw-bolder">Like edit--<?=$read['descprition'];?></h3>
                                        ...
                                        <div class="example-container">
                                            <div class="example-content">
                                                <form action="like_update.php" method="post">

                                               
                                                    <input type="hidden" class="form-control" value="<?= $read['id']; ?>" name="id" placeholder="title">
                                                    <label class="form-label">Title</label>
                                                    <input type="text" class="form-control" value="<?= $read['number']; ?>" name="number" placeholder="title">



                                                    <label class="form-label">Descprition</label>

                                                    <textarea class="form-control" name="desc" rows="4"><?= $read['descprition']; ?></textarea>
